...
* [Spring Boot Gradle Plugin Reference Guide](https://docs.spring.io/spring-boot/4.0.8-SNAPSHOT/gradle-plugin)
* [Create an OCI image](https://docs.spring.io/spring-boot/4.0.8-SNAPSHOT/gradle-plugin/packaging-oci-image.html)
